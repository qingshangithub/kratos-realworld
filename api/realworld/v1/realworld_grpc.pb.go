...
type RealWorldClient interface {
	...
	GetTags(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListofTagsReply, error)
}
...
func (c *realWorldClient) AddComments(ctx context.Context, in *AddCommentsRequest, opts ...grpc.CallOption) (*SingleCommentReply, error) {
	...
	err := c.cc.Invoke(ctx, "/helloworld.v1.RealWorld/AddComments", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *realWorldClient) GetTags(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListofTagsReply, error) {
...
func (UnimplementedRealWorldServer) GetTags(context.Context, *emptypb.Empty) (*ListofTagsReply, error) {
...
func _RealWorld_AddComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.v1.RealWorld/AddComments",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
