...
type RealWorldHTTPServer interface {
	...
	GetTags(context.Context, *emptypb.Empty) (*ListofTagsReply, error)
...
func RegisterRealWorldHTTPServer(s *http.Server, srv RealWorldHTTPServer) {
	...
	r.DELETE("DELETE /api/articles/{slug}", _RealWorld_DeleteArticle0_HTTP_Handler(srv))
...
func _RealWorld_AddComments0_HTTP_Handler(srv RealWorldHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		...
		http.SetOperation(ctx, "/helloworld.v1.RealWorld/AddComments")
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
...
type RealWorldHTTPClient interface {
	...
	GetTags(ctx context.Context, req *emptypb.Empty, opts ...http.CallOption) (rsp *ListofTagsReply, err error)
...
func (c *RealWorldHTTPClientImpl) AddComments(ctx context.Context, in *AddCommentsRequest, opts ...http.CallOption) (*SingleCommentReply, error) {
	...
	opts = append(opts, http.Operation("/helloworld.v1.RealWorld/AddComments"))
...
func (c *RealWorldHTTPClientImpl) DeleteArticle(ctx context.Context, in *DeleteArticleRequest, opts ...http.CallOption) (*emptypb.Empty, error) {
	...
	pattern := "DELETE /api/articles/{slug}"
...
func (c *RealWorldHTTPClientImpl) GetTags(ctx context.Context, in *emptypb.Empty, opts ...http.CallOption) (*ListofTagsReply, error) {
